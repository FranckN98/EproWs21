...
public class BusinessUnitKeyResultIntegrationTest extends IntegrationBase {
    ...
    class TestCasesWithAdminAccount {
        ...
        @Test
        @Ignore("This test can't be transactional, thus must be started in isolation, so that it does not interfere with other tests")
        void achievementShouldChangeAfterUpdatingCurrentValue() throws Exception {
            ...
            mockMvc.perform(
                    ...
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.achievement", is(50.0)));
        }
